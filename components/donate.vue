<template>
    <section class="responsive-padding container mx-auto px-4 py-4 pl-8">
        ...
        <ul class="list-disc list-inside">
            ...
            <li><a class="underline" href="https://github.com/sponsors/Wuemeli" target="_blank" rel="noopener noreferrer">Donate to me</a>:
                Help keep this site running: Donate to me directly to help cover the costs of running this site.</li>
    </ul>
</section></template>